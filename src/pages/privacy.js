...
const Privacy = () => (
  <div>
    ...
    <p>
      ...
      hat einen besonders hohen Stellenwert für die Geschäftsleitung der Imkerei
      Hoffmann. Eine Nutzung der Internetseiten der Imkerei Hoffmann ist
    ...
    <p>
      ...
      Übereinstimmung mit den für die Imkerei Hoffmann geltenden
    ...
    <p>
      Die Imkerei Hoffmann hat als für die Verarbeitung Verantwortlicher
    ...
    <p>
      Die Datenschutzerklärung der Imkerei Hoffmann beruht auf den
    ...
    <p>Imkerei Hoffmann</p>
    <p>Pfarrhofstraße 7</p>
    <p>94267 Prackenbach</p>
    <p>Deutschland</p>
    <p>Tel.: 099442283</p>
    <p>E-Mail: kontakt@hoffmann-imkerei.de</p>
    <p>Website: www.hoffmann-imkerei.de</p>

    <h4>3. Cookies</h4>
    <p>
      Die Internetseiten der Imkerei Hoffmann verwenden Cookies. Cookies sind
    ...
    <p>
      Durch den Einsatz von Cookies kann die Imkerei Hoffmann den Nutzern dieser
    ...
    <p>
      Die Internetseite der Imkerei Hoffmann erfasst mit jedem Aufruf der
    ...
    <p>
      ...
      Imkerei Hoffmann keine Rückschlüsse auf die betroffene Person. Diese
      ...
      erhobenen Daten und Informationen werden durch die Imkerei Hoffmann daher
    ...
    <ul style={{ listStyle: 'none' }}>
      ...
      <li>
        ...
        <p>
          ...
          Person die Löschung von personenbezogenen Daten, die bei der Imkerei
          Hoffmann gespeichert sind, veranlassen möchte, kann sie sich hierzu
          jederzeit an einen Mitarbeiter des für die Verarbeitung
          Verantwortlichen wenden. Der Mitarbeiter der Imkerei Hoffmann wird
          veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
        </p>

        <p>
          Wurden die personenbezogenen Daten von der Imkerei Hoffmann öffentlich
          ...
          so trifft die Imkerei Hoffmann unter Berücksichtigung der verfügbaren
          ...
          die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Imkerei
          Hoffmann wird im Einzelfall das Notwendige veranlassen.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          bei der Imkerei Hoffmann gespeichert sind, verlangen möchte, kann sie
          sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
          Verantwortlichen wenden. Der Mitarbeiter der Imkerei Hoffmann wird die
      ...
      <li>
        ...
        <p>
          ...
          betroffene Person jederzeit an einen Mitarbeiter der Imkerei Hoffmann
          wenden.
        </p>
      </li>
      <li>
        ...
        <p>
          Die Imkerei Hoffmann verarbeitet die personenbezogenen Daten im Falle
        ...
        <p>
          Verarbeitet die Imkerei Hoffmann personenbezogene Daten, um
          ...
          Widerspricht die betroffene Person gegenüber der Imkerei Hoffmann der
          Verarbeitung für Zwecke der Direktwerbung, so wird die Imkerei
          Hoffmann die personenbezogenen Daten nicht mehr für diese Zwecke
          verarbeiten.
        </p>
        ...
        <p>
          ...
          Verarbeitung personenbezogener Daten, die bei der Imkerei Hoffmann zu
        ...
        <p>
          ...
          Person direkt jeden Mitarbeiter der Imkerei Hoffmann oder einen
      ...
      <li>
        ...
        <p>
          ...
          betroffenen Person, trifft die Imkerei Hoffmann angemessene Maßnahmen,
    ...
    <h4>7. Zahlungsart: Datenschutzbestimmungen zu PayPal als Zahlungsart</h4>
    <p>
